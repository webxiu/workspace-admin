...
var hiprint = function (t) {
    ...
    var i = n(9),
        o = function () {
            function t() {
                this.providers = [], this.movingDistance = 0.5, this.paperHeightTrim = 1, this.text = {
                    supportOptions: [{
                        name: "title",
                        hidden: !1,
                        title: ""
    ...
    var i = function () {
        ...
        o = function () {
            ...
            return t.prototype.createTarget = function (t) {
                var e = t ? t.getFontList() || [] : []
                return this.target = $(`<div class="hiprint-option-item">
                                <div class="hiprint-option-item-label">字体</div>
                                <div class="hiprint-option-item-field">
                                <select class="auto-submit">${e.map((m) => `<option value="${m.value || ''}" >${m.title || ''}</option>`).join('')}
                            </select></div></div>`);
        ...
        C = function () {
            ...
            return t.prototype.createTarget = function (t) {
                this.target = $(`<div class="hiprint-option-item hiprint-option-item-row">
                        <div class="hiprint-option-item-label">图片地址</div>
                        <div class="hiprint-option-item-field" style="display: flex; align-items: center">
                            ...
                            <button class="hiprint-option-item-settingBtn" style="padding: 0 10px; margin: 0 0 0 5px; white-space: nowrap">选择</button>
                        </div>
                    </div>`);
    ...
    var i = function () {
        ...
        m = function () {
            ...
            return t.prototype.init = function () {
                ...
                var n = t.getTarget();
                var { scaleX: scale } = _getScale($('.hiprint-printPaper.design')[0]);
    ...
    !function (t) {
        function e(e) {
            ...
            var n = t.data(e.data.target, "hidraggable"),
                ...
                o = n.proxy,
                r = e.data,
                a = (r.startLeft + e.pageX - r.startX) / scale,
                p = (r.startTop + e.pageY - r.startY) / scale;
    ...
    n = jQuery, i = {
        ...
        this.options = n.data(t.target, "hireizeable").options, this.init(t.target);
            ...
            refreshSizeBox: function (t, box, o) {
    ...
    var _r,
        ...
        v = function (t) {
            ...
            return m(e, t), e.prototype.getReizeableShowPoints = function () {
                ...
                i.find("img").length ? i.find("img").attr("src", n) : i.html('<img style="width:100%;height:100%;object-fit: contain;" src="' + n + '">');
                i.find("img").on("error", function(e) { e.target.style.opacity = 0 });
                i.find("img").on("load", function(e) { e.target.style.opacity = 1 });
        ...
        T = function () {
            ...
            return t.prototype.subscribePaperBaseInfoChanged = function (t) {
              ...
              if (s) {
                ...
                if (s > 1) {
                  this.target.css({transformOrigin: "-2% -1%", transition: "transform 0.3s" });
                } else {
                  this.target.css({transformOrigin: "0 0"})
                }
        ...
        ct = function () {
            ...
            return t.prototype.design = function (t, e) {
              ...
              this.editingPanel.zoom(s, p);
                ...
                this.fontList = this.fontList.concat(t);

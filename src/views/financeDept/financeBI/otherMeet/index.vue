...
import { fetchOtherPayMoneyList, fetchPrePayMoneyList } from "@/api/oaManage/financeDept";
...
defineOptions({ name: "FinanceDeptFinanceBIOtherMeetIndex" });

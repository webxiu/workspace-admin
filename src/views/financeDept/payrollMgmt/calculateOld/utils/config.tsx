...
export const importType = {
  ...
  已发工资: { row: "2", moneyCol: "3", userCodeCol: "1", cardCol: "0", oldInsuranceCol: "0", hospitalInsuranceCol: "0", sybxCol: "0" }
};
...
const formConfigs1 = (addFormData) => {
  ...
  const formConfs = (chooseType): FormConfigItemType[] => {
    return [
      ...
      {
        label: "身份证列",
        hide: ["其他", "提成", "已发工资"].includes(chooseType),
        labelWidth: 100,
        prop: "cardCol",
        render: ({ formModel, row }) => {
      ...
      },
      {
        ...
        labelWidth: 100,
        prop: "moneyCol",
        hide: chooseType && !["公积金", "个税", "其他", "提成", "已发工资"].includes(chooseType),
        render: ({ formModel, row }) => {

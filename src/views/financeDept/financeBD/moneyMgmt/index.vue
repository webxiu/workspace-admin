    ...
    <div class="flex flex-1 ui-h-100 ui-w-100 ui-ov-h">
      <PureTableBar :columns="columns" @refresh="onFresh" @change-column="setUserMenuColumns">
        <template #title>
          ...
          <BlendedSearch @tagSearch="handleTagSearch" :searchOptions="searchOptions" placeholder="币种编号" searchField="currencyNumber" />
        </template>
        <template #buttons>
...
defineOptions({ name: "FinanceDeptFinanceBDMoneyMgmtIndex" });

...
export const useConfig = () => {
  ...
  const showBg = false;
  // 定义主题
  const borderImg: BorderImgType = "borderLine";
      ...
      children: [
        {
          ...
          children: [
            ...
            { span: 24, comp: h(Border, { className: "chart_02", borderImg, loading: mLoading, showBg: showBg, title: chartName.t2 }) }
          ]
        },
        {
          gutter: 10,
          ...
          children: [
            {
              ...
              direction: "row",
              style: { flex: 2 },
              comp: h(Border, { className: "chart_04", style: { marginBottom: "10px" }, borderImg, loading: mLoading, showBg: showBg, title: chartName.t4 })
            },
            {
              span: 24,
              type: "row",
        ...
        },
        {
          ...
          children: [
            ...
            {
              span: 24,
              comp: h(Border, { className: "chart_01", borderImg, loading: mLoading, showBg: showBg, title: chartName.t1, style: { marginBottom: "10px" } })
            },
            { span: 24, comp: h(Border, { className: "chart_03", borderImg, loading: mLoading, showBg: showBg, title: chartName.t3 }) }
          ]
        }
      ]
    }

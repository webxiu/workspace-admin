...
export const useConfig = () => {
  ...
  const getConfig = async (buttonList) => {
    let columnData: TableColumnList[] = [
      ...
      { label: "样机数量", prop: "sampleNum", align: "center" },
      { label: "样机类型", prop: "sampleType", align: "center" },
      { label: "电压及频率", prop: "voltageAndFrequency", align: "center" },
      { label: "交付日期", prop: "date", align: "center" }
    ];

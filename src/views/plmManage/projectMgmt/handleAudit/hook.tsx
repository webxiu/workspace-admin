...
export const useConfig = () => {
  ...
  const getConfig = async (buttonList) => {
    let columnData: TableColumnList[] = [
      ...
      { label: "评审主持人", prop: "auditMasterUserName", width: 140 },
      { label: "评审时间", prop: "date", width: 140 },
      { label: "评审裁决", prop: "auditRule", width: 140 },
      { label: "文件资料", prop: "auditFileInfo", width: 140 }
    ];
  ...
  const openDialog = (type, row?) => {
    ...
    addDialog({
      title: `${titleMap[type]}手板评审表`,
      class: "handle-audit-modal",
      width: "1450px",
      draggable: true,
      fullscreenIcon: true,

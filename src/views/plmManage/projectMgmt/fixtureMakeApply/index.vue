  ...
  <div class="ui-h-100 flex-col flex-1 main main-content">
    <div class="flex flex-1 ui-h-100 ui-w-100 ui-ov-h">
      <PureTableBar :columns="columns" @refresh="onFresh" @change-column="setUserMenuColumns">
        <template #title>
          <BlendedSearch @tagSearch="handleTagSearch" :searchOptions="searchOptions" placeholder="治夹具名称" searchField="fixtureName" />
        </template>
        <template #buttons>
...
defineOptions({ name: "PlmManageProjectMgmtFixtureMakeApplyIndex" });

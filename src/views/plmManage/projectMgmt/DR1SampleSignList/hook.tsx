...
export const useConfig = () => {
  ...
  const getConfig = async (buttonList) => {
    let columnData: TableColumnList[] = [
      ...
      { label: "产品等级", prop: "productLevel", width: 140 },
      { label: "规样机类型格明细", prop: "sampleType", width: 140 },
      { label: "样机数量", prop: "sampleNum", width: 140 },
      { label: "交付日期", prop: "deliveryDate", width: 140 },
      { label: "样机问题点总结", prop: "sampleProblemDesc", width: 140 }
    ];
  ...
  const openDialog = (type, row?) => {
    ...
    addDialog({
      title: `${titleMap[type]}DR1功能样机/客户样机签收单`,
      width: "1000px",

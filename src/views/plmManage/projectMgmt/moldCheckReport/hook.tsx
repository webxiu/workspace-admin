...
export const useConfig = () => {
  ...
  const getConfig = async (buttonList) => {
    let columnData: TableColumnList[] = [
      { label: "模具公司名称", prop: "moldCompanyName", width: 140 },
      { label: "项目工程师", prop: "projectUserName", width: 140 },
      { label: "项目名称", prop: "projectName", width: 140 },
      { label: "图纸编号", prop: "imgNo", width: 140 },
      { label: "图纸版本", prop: "imgVersion", width: 140 },
      { label: "塑料名称/牌号", prop: "plasticName", width: 140 },
      { label: "材料收缩率", prop: "materialShrinkageRate", width: 140 },
      { label: "模具穴数", prop: "moldCaveNum", width: 140 },
      { label: "模具数量", prop: "moldNum", width: 140 },
      { label: "验收时间", prop: "checkDate", width: 140 },
      { label: "成型周期", prop: "moldingCycle", width: 140 },
      { label: "模具寿命", prop: "moldAlive", width: 140 },
      { label: "模具类型", prop: "moldType", width: 140 },
      { label: "产品生产方式", prop: "productWay", width: 140 }
    ];

...
export const useConfig = () => {
  ...
  const getConfig = async (buttonList) => {
    let columnData: TableColumnList[] = [
      ...
      { label: "设备编号", prop: "deviceNo", width: 140 },
      { label: "日期", prop: "date", width: 140 },
      { label: "时间", prop: "time", width: 140 },
      { label: "温度", prop: "temperature", width: 140 },
      { label: "湿度", prop: "humidity", width: 140 },
      { label: "使用性能状态检查", prop: "usePerformance", width: 140 },
      { label: "使用人", prop: "useUserName", width: 140 },
  ...
  const openDialog = (type, row?) => {
    ...
    addDialog({
      title: `${titleMap[type]}仪器设备使用记录表`,
      class: "device-records-modal",
      width: "1200px",
      draggable: true,
      fullscreenIcon: true,

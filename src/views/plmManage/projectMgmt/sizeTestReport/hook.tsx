...
export const useConfig = () => {
  ...
  const searchOptions = reactive<SearchOptionType[]>([
    ...
    { label: "图纸编号", value: "drawNo" },
    { label: "客户", value: "customer" },
    { label: "测量员", value: "testUserName" },
  ...
  const getConfig = async (buttonList) => {
    let columnData: TableColumnList[] = [
      ...
      { label: "项目编号", prop: "projectNo", align: "center" },
      { label: "项目名称", prop: "projectName", align: "center" },
      { label: "图纸编号", prop: "drawNo", align: "center" },
      { label: "客户", prop: "customer", align: "center" },
      { label: "测量员", prop: "testUserName", align: "center" },

...
export const useConfig = () => {
  ...
  const getConfig = async (buttonList) => {
    let columnData: TableColumnList[] = [
      { label: "模号", prop: "moldNo", width: 140 },
      { label: "产品编号", prop: "productNo", width: 140 },
  ...
  const openDialog = (type, row?) => {
    ...
    addDialog({
      title: `${titleMap[type]}模具设计评审表`,
      class: "mold-design-audit-modal",
      width: "1600px",
      draggable: true,
      fullscreenIcon: true,
      ...
      beforeSure: (done) => {
        ...
        console.log(detailRef.value.dataList, "dataList===");

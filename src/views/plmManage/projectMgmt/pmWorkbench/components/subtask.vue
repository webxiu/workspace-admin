<template>
  <div class="subtask">
    ...
    >
      <div class="task">
        <span v-if="!editTaskNameFlag" @click="editTaskNameFlag = true">{{ item.taskName }}</span>
        <span v-else>
          <el-input
            placeholder="请输入任务名称"
      ...
      <div class="right-pop" v-if="showFloatPop" aria-hidden>
        <div class="icon-list">
          ...
          <div class="icon-item" style="margin: 0 8px" @click="() => delItem(idx)">
      ...
      <div class="date" @click.stop="clickDate">
        <div class="pre-icon">
      ...
      <el-popover v-model:visible="visiblePop2" :show-arrow="false" placement="bottom-start" :offset="4" :width="250" trigger="click">
        <template #reference>
          <div class="priority">
            <div class="pre-icon">
...
const props = defineProps(["arrowRight", "childrenList"]);

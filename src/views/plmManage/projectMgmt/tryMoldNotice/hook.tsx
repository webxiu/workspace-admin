...
export const useConfig = () => {
  ...
  const searchOptions = reactive<SearchOptionType[]>([
    ...
    { label: "试模类别", value: "tryMoldCategory" },
  ...
  const handleTagSearch = (val) => {
    ...
    formData["tryMoldCategory"] = val.tryMoldCategory;

...
const getTableList = () => {
  return new Promise<boolean>((resolve, reject) => {
    // if (!formData.manualId) return message.warning("请选择指导书")
    loading.value = true;
      ...
      <div class="flex just-between align-center">
        <div class="flex flex-1 items-center mb-15">
          ...
          <el-select
            ...
            @change="onChange"
          >
            <el-option label="" value="" v-if="treeOptions.length" disabled style="color: var(--el-text-color-regular); cursor: default">

...
export const useMachine = () => {
  ...
  const onAdd = () => {
    ...
    router.push("/marketing/saleManage/handleMake/add/index");
  };
  ...
  const onEdit = () => {
    ...
    router.push("/marketing/saleManage/handleMake/add/index?id=" + curRow.value.id);
  };
  ...
  const onPrint = () => {
    if (!curRow.value) return message.warning("请选择一条记录");
    router.push("/marketing/saleManage/handleMake/print/index?id=" + curRow.value.id);
  };

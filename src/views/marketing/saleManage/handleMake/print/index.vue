...
defineOptions({ name: "MarketingHandleMakePrintIndex" });
...
const onBack = () => {
  router.push("/marketing/saleManage/handleMake/index?menuCode=11&from=/marketing&menuId=332&menuName=手板制作申请");
};

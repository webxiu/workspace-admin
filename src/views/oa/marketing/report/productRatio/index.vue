...
defineOptions({ name: "OaMarketingReportProductRatioIndex" });
...
<template>
  <Row>
    ...
    <Col>
      <div ref="chartRef1" v-loading="loading" :style="{ height: maxHeight + 40 + 'px', minHeight: '640px' }" class="border-line m-2" />
    </Col>
  </Row>
</template>
